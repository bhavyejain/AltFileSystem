...
{   
    ...
    ssize_t num_of_blocks_to_allocate[] = {8, 12, 100, 524, 530, 1044}; // TODO: Add more for triple indirect once moved to disk
    ...
    for(int k = 0; k < sizeof(num_of_blocks_to_allocate)/sizeof(num_of_blocks_to_allocate[0]); k++)
    {
        ...
        ssize_t logical_blocks_to_remove_from[] = {3, 7, 8, 11, 12, 14, 16, 60, 523, 524, 526, 530, 1040}; // TODO: Add more here for triple indirect once moved to disk
